...
namespace MissionPlanner.Utilities
{
    ...
    public class ThemeColorTable
    {
        ...
        public void InitColors()
        {
            ...
            // Default theme file name (palette matches Saif Seas brand: cyan accent on dark slate)
            strThemeName = "BurntKermit.mpsystheme";

            colors.Add("Background", Color.FromArgb(14, 20, 26), "BGColor");						// Main shell / menu background
            colors.Add("Control Background", Color.FromArgb(28, 40, 52), "ControlBGColor");		// Panels, inputs
            colors.Add("Text", Color.White, "TextColor");
            colors.Add("TextBox Background", Color.FromArgb(28, 40, 52), "BGColorTextBox");
            colors.Add("Button Text", Color.White, "ButtonTextColor");				// Readable on cyan buttons
            colors.Add("Button Background top", Color.FromArgb(0, 174, 239), "ButBG");				// Logo cyan #00AEEF
            colors.Add("Button Background bottom", Color.FromArgb(91, 207, 255), "ButBGBot");
            colors.Add("ProgressBar Top", Color.FromArgb(0, 135, 184), "ProgressBarColorTop");
            colors.Add("ProgressBar Bottom", Color.FromArgb(0, 174, 239), "ProgressBarColorBot");
            colors.Add("ProgressBar Outline", Color.FromArgb(74, 144, 184), "ProgressBarOutlineColor");
            colors.Add("BannerColor1", Color.FromArgb(0, 61, 85), "BannerColor1");			// Deep teal (nautical)
            colors.Add("BannerColor2", Color.FromArgb(0, 174, 239), "BannerColor2");			// Cyan highlight
            colors.Add("Disabled Button", Color.FromArgb(150, 20, 35, 48), "ColorNotEnabled");
            colors.Add("Button Mouseover", Color.FromArgb(73, 0, 120, 168), "ColorMouseOver");
            colors.Add("Button Mousedown", Color.FromArgb(73, 0, 90, 128), "ColorMouseDown");
            colors.Add("CurrentPPM Background", Color.FromArgb(0, 201, 167), "CurrentPPMBackground");	// Teal (distinct from sky cyan)
            colors.Add("Graph Chart Fill", Color.FromArgb(18, 25, 32), "ZedGraphChartFill");
            colors.Add("Graph Pane Fill", Color.FromArgb(26, 37, 46), "ZedGraphPaneFill");
            colors.Add("Graph Legend Fill", Color.FromArgb(45, 61, 76), "ZedGraphLegendFill");
            colors.Add("Rich Text Box text", Color.WhiteSmoke, "RTBForeColor");
            colors.Add("BackStageView Button Area", Color.FromArgb(10, 15, 20), "BSVButtonAreaBGColor");
            colors.Add("BSV Unselected Text", Color.FromArgb(168, 184, 200), "UnselectedTextColour");
            colors.Add("Horizontal ProgressBar", Color.FromArgb(0, 174, 239), "HorizontalPBValueColor");
            colors.Add("HUD text and drawings", Color.LightGray, "HudText");
            colors.Add("HUD Ground top", Color.FromArgb(74, 95, 110), "HudGroundTop");
            colors.Add("HUD Ground bottom", Color.FromArgb(21, 32, 40), "HudGroundBot");
            colors.Add("HUD Sky top", Color.FromArgb(0, 153, 204), "HudSkyTop");
            colors.Add("HUD Sky bottom", Color.FromArgb(102, 217, 255), "HudSkyBot");
    ...
    public class ThemeManager
    {
        ...
        // Initialize to Saif Seas default (overwritten when theme XML loads)
        public static Color BGColor = Color.FromArgb(14, 20, 26);
        public static Color ControlBGColor = Color.FromArgb(28, 40, 52);
